    ...
    <form onSubmit={handleSubmit}>
      <div className="flex items-end gap-2">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="rounded-full bg-linear-to-r from-brand-500 to-brand-600 px-4 py-2 font-semibold text-white shadow-soft transition hover:from-brand-600 hover:to-brand-700 disabled:opacity-50"
        >
